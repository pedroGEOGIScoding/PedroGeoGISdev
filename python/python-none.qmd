...
* In a few words:
  ...
  + or even simpler: the `is` statement is syntactic sugar for `id(a) == id(b)`.
  + The `id()` function is a built-in function in Python. It accepts a single parameter and is used to return the identity of an object.
