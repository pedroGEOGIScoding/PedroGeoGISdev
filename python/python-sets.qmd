...
![Union operation in python](/images/python/python-set-union.png){width=50% .preview-image}
...
![Intersection operation in python](/images/python/python-set-intersection.png){width=50% .preview-image}
...
![Difference operation in python](/images/python/python-set-difference.png){width=50% .preview-image}
...
![Symmetric difference operation in python](/images/python/python-set-symmetricdiff.png){width=50% .preview-image}
