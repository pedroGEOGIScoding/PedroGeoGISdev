---
title: "Meetings, Impediments and Iterations"
subtitle: SCRUM Step 1
author: albertprofe
date: "06/01/2021"
date-modified: last-modified
date-format: full
description: Effective and well-organized meetings are fundamental to SCRUM Agile
categories: [scrum, meetings, impediments]
toc: true
...
📘 **Summary: SCRUM Step 1 - Meetings, Impediments and Iterations**
...
**Keywords: SCRUM Step 1 - Meetings, Impediments and Iterations**
...
::: {.callout-important}
In the Scrum framework, the question **"What is your impediment?"** is significant because it aligns with the core principles of transparency, inspection, and adaptation. Scrum is an agile project management framework that emphasizes collaboration, flexibility, continuous improvement and [user-story driven-aproach](/scrum/scrum2.qmd).
:::
...
All these concepts are building the [user-story driven-aproach](/scrum/scrum2.qmd) that enhances **productivity**.
:::
...
- [Step 1: Meetings and impediments](https://sites.google.com/view/gestioprojectes/llegir/setmana1){.external}
